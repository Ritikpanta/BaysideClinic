...
.auth-left .brand img { width: 72px; height: 72px; border-radius: 10px; object-fit: cover; }
...
.auth-card h2 { font-family:'Bitcount Grid Double' , 'Instrument Serif', serif; font-size: 24px; color: #0a1628; font-weight: 400; margin-bottom: 6px; text-align: center; }
